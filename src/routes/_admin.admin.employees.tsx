        ...
        <div className="grid gap-3">
          {data?.employees
            ...
            .map((e) => {
              ...
              const isTeamLead = e.roles.includes("team_lead");
              return (
                <Link
                  key={e.id}
                  to="/admin/$employeeId"
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isTeamLead && (
                          <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-blue-600/15 text-blue-600 text-[10px] uppercase tracking-wider font-medium">
                            Team Lead
                          </span>
                        )}
                      </div>
