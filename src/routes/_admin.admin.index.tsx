              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  {e.roles?.includes("team_lead") && (
                    <span className="inline-flex items-center px-1.5 py-0.5 rounded-full bg-blue-600/15 text-blue-600 text-[10px] uppercase tracking-wider font-medium shrink-0">
                      Team Lead
                    </span>
                  )}
                </div>
