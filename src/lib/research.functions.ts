...
import { researchCompany } from "@/server/research.server";
    ...
    try {
      ...
      const { error: upErr } = await supabase
        ...
        .update({
          ...
          research_raw: { sources: result.sources, debug: result.debug, phones: result.phones, fordonMd: result.fordonMd } as any,
